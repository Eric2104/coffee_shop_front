...
const ProductCard = (props: ProductCardProps) => {
  ...
  return (
    <Link
      ...
      className="relative p-2 transition-all duration-100 rounded-lg hover:shadow-md mx-auto"
    >
...
<CarouselContent>
            ...
            <CarouselItem className="group">
              <img
                ...
                alt="Image"
                className="rounded-xl w-full md:w-full h-48  object-cover"
              />
              <div
